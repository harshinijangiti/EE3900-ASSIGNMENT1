...
\begin{lstlisting}
$ wget https://github.com/harshinijangiti/EE3900-ASSIGNMENT1/blob/master/pingala/codes/1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/harshinijangiti/EE3900-ASSIGNMENT1/blob/master/pingala/codes/2_1.py
\end{lstlisting}
...
Download the Python code using
\begin{lstlisting}
$ wget https://github.com/harshinijangiti/EE3900-ASSIGNMENT1/blob/master/pingala/codes/2_2.py
\end{lstlisting}
